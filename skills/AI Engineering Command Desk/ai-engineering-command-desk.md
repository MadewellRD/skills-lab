...
- the output can be executed without {{CODING_AGENT}} rediscovering scope.
...
- Collapse exploratory context into source facts, decisions, assumptions, validation gates, and halt conditions before handing work to {{CODING_AGENT}}.
