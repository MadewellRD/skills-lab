...
Cloud Infrastructure Command Desk rebuilt on the `frontier-2026-07` capability profile. Every skill in this
...
- Packaged skills: `dist/packages/cloud-infrastructure-command-desk/`
- Checksums: `dist/manifests/cloud-infrastructure-command-desk-CHECKSUMS.txt`
- JSON manifest: `dist/manifests/cloud-infrastructure-command-desk-v1.1.0.json`
