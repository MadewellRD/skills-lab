...
FinOps Command Desk rebuilt on the `frontier-2026-07` capability profile. Every skill in this
...
- Packaged skills: `dist/packages/finops-command-desk/`
- Checksums: `dist/manifests/finops-command-desk-CHECKSUMS.txt`
- JSON manifest: `dist/manifests/finops-command-desk-v1.1.0.json`
