...
Android Command Desk rebuilt on the `frontier-2026-07` capability profile. Every skill in this
...
- Packaged skills: `dist/packages/android-command-desk/`
- Checksums: `dist/manifests/android-command-desk-CHECKSUMS.txt`
- JSON manifest: `dist/manifests/android-command-desk-v1.1.0.json`
