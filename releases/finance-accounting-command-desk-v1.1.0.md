...
Finance Accounting Command Desk rebuilt on the `frontier-2026-07` capability profile. Every skill in this
...
- Packaged skills: `dist/packages/finance-accounting-command-desk/`
- Checksums: `dist/manifests/finance-accounting-command-desk-CHECKSUMS.txt`
- JSON manifest: `dist/manifests/finance-accounting-command-desk-v1.1.0.json`
