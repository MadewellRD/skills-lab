...
Security Command Desk rebuilt on the `frontier-2026-07` capability profile. Every skill in this
...
- Packaged skills: `dist/packages/security-command-desk/`
- Checksums: `dist/manifests/security-command-desk-CHECKSUMS.txt`
- JSON manifest: `dist/manifests/security-command-desk-v1.1.0.json`
