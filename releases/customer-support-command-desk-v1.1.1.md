# Customer Support Command Desk v1.1.1
...
Customer Support Command Desk rebuilt on the `frontier-2026-07` capability profile. Every skill in this
...
- Packaged skills: `dist/packages/customer-support-command-desk/`
- Checksums: `dist/manifests/customer-support-command-desk-CHECKSUMS.txt`
- JSON manifest: `dist/manifests/customer-support-command-desk-v1.1.1.json`
