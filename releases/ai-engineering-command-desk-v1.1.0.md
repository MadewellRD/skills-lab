...
AI Engineering Command Desk rebuilt on the `frontier-2026-07` capability profile. Every skill in this
...
- Packaged skills: `dist/packages/ai-engineering-command-desk/`
- Checksums: `dist/manifests/ai-engineering-command-desk-CHECKSUMS.txt`
- JSON manifest: `dist/manifests/ai-engineering-command-desk-v1.1.0.json`
