...
GRC Command Desk rebuilt on the `frontier-2026-07` capability profile. Every skill in this
...
- Packaged skills: `dist/packages/grc-command-desk/`
- Checksums: `dist/manifests/grc-command-desk-CHECKSUMS.txt`
- JSON manifest: `dist/manifests/grc-command-desk-v1.1.0.json`
