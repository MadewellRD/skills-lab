# SRE Reliability Command Desk v1.1.1
...
SRE Reliability Command Desk rebuilt on the `frontier-2026-07` capability profile. Every skill in this
...
- Packaged skills: `dist/packages/sre-reliability-command-desk/`
- Checksums: `dist/manifests/sre-reliability-command-desk-CHECKSUMS.txt`
- JSON manifest: `dist/manifests/sre-reliability-command-desk-v1.1.1.json`
