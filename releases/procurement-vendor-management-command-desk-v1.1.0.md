...
Procurement Vendor Management Command Desk rebuilt on the `frontier-2026-07` capability profile. Every skill in this
...
- Packaged skills: `dist/packages/procurement-vendor-management-command-desk/`
- Checksums: `dist/manifests/procurement-vendor-management-command-desk-CHECKSUMS.txt`
- JSON manifest: `dist/manifests/procurement-vendor-management-command-desk-v1.1.0.json`
