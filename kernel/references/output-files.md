...
```markdown
Created the downloadable prompt: [pr-prompt-corpus-catalog.md](sandbox:/mnt/data/pr-prompt-corpus-catalog.md). Paste everything under `## Prompt` into {{CODING_AGENT}}.
```
