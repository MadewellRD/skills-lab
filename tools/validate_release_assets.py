...
ARTIFACT_SETS = [
    ArtifactSet("SDLC Command Desk",
                REPO / "dist" / "manifests" / "sdlc-command-desk-CHECKSUMS.txt",
                REPO / "dist" / "packages" / "sdlc-command-desk", 20),
    ArtifactSet("Web Development Command Desk",
                REPO / "dist" / "manifests" / "web-development-command-desk-CHECKSUMS.txt",
                REPO / "dist" / "packages" / "web-development-command-desk", 14),
    ArtifactSet("AI Engineering Command Desk",
                REPO / "dist" / "manifests" / "ai-engineering-command-desk-CHECKSUMS.txt",
                REPO / "dist" / "packages" / "ai-engineering-command-desk", 18),
    ArtifactSet("Sales Command Desk",
                REPO / "dist" / "manifests" / "sales-command-desk-CHECKSUMS.txt",
                REPO / "dist" / "packages" / "sales-command-desk", 13),
    ArtifactSet("Product Command Desk",
                REPO / "dist" / "manifests" / "product-command-desk-CHECKSUMS.txt",
                REPO / "dist" / "packages" / "product-command-desk", 16),
    ArtifactSet("Android Command Desk",
                REPO / "dist" / "manifests" / "android-command-desk-CHECKSUMS.txt",
                REPO / "dist" / "packages" / "android-command-desk", 14),
    ArtifactSet("iOS Command Desk",
                REPO / "dist" / "manifests" / "ios-command-desk-CHECKSUMS.txt",
                REPO / "dist" / "packages" / "ios-command-desk", 14),
]
