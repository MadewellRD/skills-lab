...
`frontend-engineering-desk` is part of the Web Development Command Desk suite.

## Role

frontend architecture and implementation handoff.

## Suite position

- Suite: Web Development Command Desk
- Skill slug: `frontend-engineering-desk`
- Default next stage: `web-security-secops-desk`
