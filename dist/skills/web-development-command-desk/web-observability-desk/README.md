...
`web-observability-desk` is part of the Web Development Command Desk suite.

## Role

RUM, synthetic checks, dashboards, alerts, and incidents.

## Suite position

- Suite: Web Development Command Desk
- Skill slug: `web-observability-desk`
- Default next stage: `web-maintenance-growth-desk`
