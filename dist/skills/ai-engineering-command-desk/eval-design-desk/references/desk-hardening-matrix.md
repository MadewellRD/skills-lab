...
A desk is not hardened if a downstream coding agent must infer target repo or base branch, source facts, allowed and forbidden files, validation commands, acceptance criteria, safety gates, report paths, PR title/body expectations, or stop line.
