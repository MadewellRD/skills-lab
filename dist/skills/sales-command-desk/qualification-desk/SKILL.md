...
description: score opportunities against meddicc, bant, or local qualification frameworks with evidence-backed gaps and next actions. use when the assistant needs to perform or continue sales revenue command desk work involving accounts, leads, opportunities, crm, calendar, email, files, prospecting, proposals, forecasts, renewals, or customer handoffs.
---
