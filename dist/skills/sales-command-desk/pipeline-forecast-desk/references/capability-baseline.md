...
| Parallel parallel workers | native | Fan out over independent items instead of looping. |
...
**Verification.** Never author "add a verification step" or "use a parallel worker to
