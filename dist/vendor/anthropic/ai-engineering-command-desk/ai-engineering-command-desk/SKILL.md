...
- the output can be executed without Claude Code rediscovering scope.
...
- Collapse exploratory context into source facts, decisions, assumptions, validation gates, and halt conditions before handing work to Claude Code.
