...
description: build account briefs, stakeholder maps, whitespace hypotheses, and meeting agendas from crm, files, and public account evidence. use when Claude needs to perform or continue sales revenue command desk work involving accounts, leads, opportunities, crm, calendar, email, files, prospecting, proposals, forecasts, renewals, or customer handoffs.
---
