---
name: proposal-desk
description: create customer-facing proposal, scope, deck, docx, and pdf drafts with brand, pricing, and approval controls. use when Gemini needs to perform or continue sales revenue command desk work involving accounts, leads, opportunities, crm, calendar, email, files, prospecting, proposals, forecasts, renewals, or customer handoffs.
---
