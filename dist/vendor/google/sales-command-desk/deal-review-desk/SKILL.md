...
description: prepare internal deal reviews with risks, asks, commercial impact, approvals, and recommended decisions. use when Gemini needs to perform or continue sales revenue command desk work involving accounts, leads, opportunities, crm, calendar, email, files, prospecting, proposals, forecasts, renewals, or customer handoffs.
---
