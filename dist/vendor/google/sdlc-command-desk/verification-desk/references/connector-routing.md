...
If release scope is ambiguous, state the assumed scope inline and continue. Halt only when proceeding would assert release readiness that the evidence cannot support (release integrity).
