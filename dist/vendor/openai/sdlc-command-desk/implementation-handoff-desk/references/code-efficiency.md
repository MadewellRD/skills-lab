...
Use this reference when drafting implementation handoffs for Codex or other coding agents. The goal is to spend fewer agent tokens on invention and more on editing, testing, and verification.
