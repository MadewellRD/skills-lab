...
- the output can be executed without Codex rediscovering scope.
...
- Collapse exploratory context into source facts, decisions, assumptions, validation gates, and halt conditions before handing work to Codex.
