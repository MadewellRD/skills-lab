...
- The data model, the pipeline, or the reporting layer itself needs changing: route to the data suite, and package any implementation change for Codex through the software lifecycle suite.
