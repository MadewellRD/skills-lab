...
|---|---|---|---|---|---|---|
| Web Development Command Desk | v0.3.0 | `skills/Web Development Command Desk/` | `dist/skills/web-development-command-desk/` | `dist/packages/web-development-command-desk/` | Yes: `web-development-command-desk-v0.3.0`; GitHub `Latest` | Published |
...
| Android Command Desk | v0.1.0 | `skills/Android Command Desk/` | `dist/skills/android-command-desk/` | `dist/packages/android-command-desk/` | Yes: `android-command-desk-v0.1.0` | Published |
| iOS Command Desk | v0.1.0 | `skills/iOS Command Desk/` | `dist/skills/ios-command-desk/` | `dist/packages/ios-command-desk/` | Yes: `ios-command-desk-v0.1.0` | Published |
...
## Android Command Desk - v0.1.0

14 desks. Covers Android app development and Android game development from requirements through release, Play Store operations, observability/live ops, and maintenance.

Checksums: `CHECKSUMS-android-command-desk-v0.1.0.txt` | Packages: `dist/packages/android-command-desk/`

| Order | Skill | Status |
|---:|---|---|
| 000 | `android-command-desk` | packaged |
| 001 | `android-product-requirements-desk` | packaged |
| 002 | `android-technical-discovery-desk` | packaged |
| 003 | `android-architecture-design-desk` | packaged |
| 004 | `android-ui-ux-desk` | packaged |
| 005 | `android-app-engineering-desk` | packaged |
| 006 | `android-game-engineering-desk` | packaged |
| 007 | `android-backend-integration-desk` | packaged |
| 008 | `android-security-privacy-desk` | packaged |
| 009 | `android-performance-optimization-desk` | packaged |
| 010 | `android-testing-qa-desk` | packaged |
| 011 | `android-release-store-ops-desk` | packaged |
| 012 | `android-observability-liveops-desk` | packaged |
| 013 | `android-maintenance-growth-desk` | packaged |

---

## iOS Command Desk - v0.1.0

14 desks. Mirrors the released mobile taxonomy and covers iOS app/game delivery from requirements through App Store operations, observability/live ops, maintenance, and growth.

Checksums: `CHECKSUMS-ios-command-desk-v0.1.0.txt` | Packages: `dist/packages/ios-command-desk/`

| Order | Skill | Status |
|---:|---|---|
| 000 | `ios-command-desk` | packaged |
| 001 | `ios-product-requirements-desk` | packaged |
| 002 | `ios-technical-discovery-desk` | packaged |
| 003 | `ios-architecture-design-desk` | packaged |
| 004 | `ios-ui-ux-desk` | packaged |
| 005 | `ios-app-engineering-desk` | packaged |
| 006 | `ios-game-engineering-desk` | packaged |
| 007 | `ios-backend-integration-desk` | packaged |
| 008 | `ios-security-privacy-desk` | packaged |
| 009 | `ios-performance-optimization-desk` | packaged |
| 010 | `ios-testing-qa-desk` | packaged |
| 011 | `ios-release-app-store-ops-desk` | packaged |
| 012 | `ios-observability-liveops-desk` | packaged |
| 013 | `ios-maintenance-growth-desk` | packaged |
...
The following suites have `skills/` directories with README stubs or preserved source and no dist content yet.
