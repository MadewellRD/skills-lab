...
| Android Command Desk | v0.1.0-source | `skills/Android Command Desk/` | Generated by `tools/generate_android_command_desk_release.py` | Generated by `tools/generate_android_command_desk_release.py` | No | Source complete; packaging generator ready |
...
## Android Command Desk — v0.1.0-source

14 source desks. Covers Android app development and Android game development from requirements through release, Play Store operations, observability/live ops, and maintenance. Dist packages are generated intentionally through `tools/generate_android_command_desk_release.py`.

| Order | Skill | Status |
|---:|---|---|
| 000 | `000-android-command-desk` | source complete |
| 001 | `001-android-product-requirements-desk` | source complete |
| 002 | `002-android-technical-discovery-desk` | source complete |
| 003 | `003-android-architecture-design-desk` | source complete |
| 004 | `004-android-ui-ux-desk` | source complete |
| 005 | `005-android-app-engineering-desk` | source complete |
| 006 | `006-android-game-engineering-desk` | source complete |
| 007 | `007-android-backend-integration-desk` | source complete |
| 008 | `008-android-security-privacy-desk` | source complete |
| 009 | `009-android-performance-optimization-desk` | source complete |
| 010 | `010-android-testing-qa-desk` | source complete |
| 011 | `011-android-release-store-ops-desk` | source complete |
| 012 | `012-android-observability-liveops-desk` | source complete |
| 013 | `013-android-maintenance-growth-desk` | source complete |
